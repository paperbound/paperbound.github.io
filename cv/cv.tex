...
\newcommand{\hlp}[1]{{\color{Maroon}#1}}
	...
	I maintained ad-serving systems, developed SDK integrations for Facebook (Meta Business Partner) product, migrated components from \hll{PHP} to \hll{Java}, configured \textit{system orchestration} via \hlp{puppet} managing \hlp{TLS/SSL} cert distributions for the internal \hlp{PKI}, and moved the \textit{data pipeline} from \hlp{Softlayer} to \hlp{AWS}
