...
\newcommand{\hlp}[1]{{\color{Maroon}#1}}
	...
	%product, migrated components from \hll{PHP} to \hll{Java}, configured \textit{system orchestration} via \hlp{puppet}
	...
	I have some freelance experience developing on \hlp{GitLab}, \hlp{GCP}, and the \hlp{MERN} stack. I have several hobby projects in \hll{Swift}-\hlp{iOS}, \hll{Java}-\hlp{Android}. I like programming small 2D platformer games in \hll{JS} / \hlp{WebGL} and writing small ray tracking programs in \hll{C++} and \hll{Rust}
